    ...
    <div className="w-full max-w-sm sm:max-w-md mx-auto px-4 sm:px-0">
      <div className='w-full p-4 sm:p-6 rounded-lg shadow-md bg-gray-400 bg-clip-padding backdrop-filter backdrop-blur-md bg-opacity-10 border border-gray-100'>
        ...
        <form onSubmit={onSubmitHandler} action="">
          ...
          <p className='text-center my-2 text-sm sm:text-base'>Don't have an account? <Link to="/signup"> signup </Link></p>
          <div>
            <button type="submit" className='btn btn-block btn-sm sm:btn-md mt-2 border border-slate-700'>Login</button>
          </div>
        </form>
      </div>
    </div>
